...
class LagrangeApproximation(object):
    ...
    def getInterpolationMatrix(self, times):
        ...
        Returns
        -------
        PInter : np.2darray(J, M)
            The interpolation matrix, with :math:`J` rows (size of the **times**
            parameter) and :math:`M` columns.
